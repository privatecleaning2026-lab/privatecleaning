...
const translations: Record<Language, Dictionary> = {
  pt: {
    ...
    'nav.login': 'Portal Privado',
    'footer.desc': 'Fornecemos equipas rigorosamente selecionadas e com formação contínua para a limpeza e manutenção de espaços residenciais e empresariais.',
    'home.subtitle': 'Cascais • Estoril • Lisboa',
    'home.title1': 'Profissionais de',
    'home.title2': 'Excelência',
    'home.desc': 'Mais de duas décadas de experiência. Fornecemos equipas selecionadas e com formação contínua para a limpeza e manutenção do seu espaço.',
    ...
    'srv.s1.desc': 'O nosso serviço core. Intervenções de limpeza profunda ou manutenção regular. A equipa é instruída no tratamento de materiais delicados.',
    ...
    'srv.s2.desc': 'Para famílias que necessitam de staff a tempo inteiro ou parcial. Fazemos a triagem e formação contínua das melhores profissionais.',
    ...
    'srv.s3.desc': 'Limpeza e manutenção programada para áreas comuns de condomínios de luxo e escritórios que exigem um brio superior.',
    ...
    'phil.title1': 'A Nossa',
    'phil.title2': 'Filosofia',
    'phil.desc': 'Acreditamos que o verdadeiro luxo é a paz de espírito. A nossa operação assenta em três pilares inegociáveis:',
    'phil.p1.title': 'Escrutínio Rigoroso',
    'phil.p1.desc': 'Todas as nossas colaboradoras passam por verificação de antecedentes, análise de referências e formação contínua.',
    'phil.p2.title': 'Segurança Contratual',
    'phil.p2.desc': 'Operamos ao abrigo de Acordos de Confidencialidade (NDA) estritos, garantindo que a rotina da sua casa ou empresa permanece blindada.',
    'phil.p3.title': 'Proteção Integral',
    'phil.p3.desc': 'Atuamos com apólices de Responsabilidade Civil e Acidentes de Trabalho, eliminando qualquer risco legal para si.',
    'login.title': 'Portal Privado',
    'login.subtitle': 'Acesso Exclusivo a Clientes',
    'login.email': 'Email',
    'login.pass': 'Palavra-passe',
    'login.btn': 'Entrar de Forma Segura'
  },
  en: {
    'nav.services': 'Services',
    'nav.philosophy': 'Philosophy',
    'nav.contact': 'Inquiry',
    'nav.login': 'Private Portal',
    'footer.desc': 'We provide rigorously selected and continuously trained teams for the cleaning and maintenance of residences and corporate spaces.',
    'home.subtitle': 'Cascais • Estoril • Lisbon',
    'home.title1': 'Professionals of',
    'home.title2': 'Excellence',
    'home.desc': 'Over two decades of experience. We provide selected teams with continuous training for the cleaning and maintenance of your space.',
    ...
    'home.m3.desc': 'From a deep cleaning intervention to fixed contracts for companies, we adapt to your scale.',
    'srv.title1': 'Our',
    'srv.title2': 'Services',
    ...
    'srv.s1.desc': 'Our core service. Deep cleaning interventions or regular maintenance. The team is trained in treating delicate materials.',
    ...
    'srv.s2.desc': 'For families requiring full or part-time staff. We screen and provide continuous training for the best professionals.',
    ...
    'phil.title1': 'Our',
    'phil.title2': 'Philosophy',
    'phil.desc': 'We believe true luxury is peace of mind. Our operation rests on three non-negotiable pillars:',
    'phil.p1.title': 'Rigorous Screening',
    'phil.p1.desc': 'All our collaborators undergo background checks, reference analysis, and continuous training.',
    'phil.p2.title': 'Contractual Security',
    'phil.p2.desc': 'We operate under strict Non-Disclosure Agreements (NDAs), ensuring your family’s or company’s routine remains completely shielded.',
    'phil.p3.title': 'Comprehensive Protection',
    'phil.p3.desc': 'We operate with Liability and Workplace Accident insurance, eliminating any legal risk for you.',
    'login.title': 'Private Portal',
    'login.subtitle': 'Exclusive Client Access',
    'login.email': 'Email',
    'login.pass': 'Password',
    'login.btn': 'Sign In Securely'
  }
};
